...
// Update character length and set color like red when reached to the maximum character amount
...
// set specific date messages into the UI
...
// remove previous messages from the UI
